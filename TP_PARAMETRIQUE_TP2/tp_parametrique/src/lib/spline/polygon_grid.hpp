...
public:
    ...
    void set_tore(int const size_u_param,int const size_v_param, float r_int_param, float r_ext_param);
    void set_hyperbolique(int const size_u_param,int const size_v_param, float a_param, float b_param, float h_param);
    void set_catenoide(int const size_u_param,int const size_v_param, float r_param, float h_param);
    
    void set_helicoide(int const size_u_param,int const size_v_param, float n_spire_param,float l_param, float h_spire_param);
    void set_pseudo_sphere(int const size_u_param,int const size_v_param, float r_param, float h_param);
    void set_visage(int const size_u_param,int const size_v_param, float r_param, float h_nez);

 ...
 * get_file_content                                                          *
\*****************************************************************************/
static std::string get_file_content(std::string const& filename)
{
    if(filename=="")
        return "";
    ...
    else
    {
        ...
        std::cout<<" => Check if this file exists, and the current executable path"<<std::endl;
